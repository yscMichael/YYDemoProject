//
//  YYSingleCellReuseController.swift
...
class YYSingleCellReuseController: UIViewController {
    //MARK: - 属性 -
    ///可见cell(方案一)
...
extension YYSingleCellReuseController: UIScrollViewDelegate{
    //开始滚动
...
//MARK:UICollectionViewDelegate
extension YYSingleCellReuseController: UICollectionViewDelegate{
    
}

//MARK:UICollectionViewDataSource
extension YYSingleCellReuseController: UICollectionViewDataSource{
